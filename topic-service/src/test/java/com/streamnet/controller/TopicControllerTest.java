...
import com.streamnet.dto.request.SuggestedTopicsRequest;
import com.streamnet.dto.request.TopicsCategoriesRequest;
...
public class TopicControllerTest {
    ...
    public void getTopicsByCategories() throws Exception {
        ...
        topicsRequest.setCategories(Arrays.asList(TopicCategory.ONLY_ON_STREAMNET, TopicCategory.GAMING));
        ...
        mockMvc.perform(post(PathConstants.UI_V1_TOPICS + PathConstants.CATEGORY)
                ...
                .andExpect(jsonPath("$[0].topicsByCategories[0].topicCategory").value(TopicCategory.ONLY_ON_STREAMNET.toString()))
