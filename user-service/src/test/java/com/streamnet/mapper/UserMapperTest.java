...
import com.streamnet.UserServiceTestHelper;
import com.streamnet.commons.dto.HeaderResponse;
import com.streamnet.commons.mapper.BasicMapper;
import com.streamnet.dto.request.SearchTermsRequest;
import com.streamnet.dto.request.UserRequest;
import com.streamnet.dto.response.AuthUserResponse;
import com.streamnet.dto.response.UserProfileResponse;
...
public class UserMapperTest {
    ...
    @Test
    public void startUseStreamNet() {
        when(userService.startUseStreamNet()).thenReturn(true);
        assertTrue(userService.startUseStreamNet());
        verify(userService, times(1)).startUseStreamNet();
    }
