...
import com.streamnet.dto.response.*;
import com.streamnet.mapper.AuthenticationMapper;
import com.streamnet.mapper.UserMapper;
...
public class UserController {
    ...
    public ResponseEntity<Boolean> startUseStreamNet() {
        return ResponseEntity.ok(userMapper.startUseStreamNet());
    }
