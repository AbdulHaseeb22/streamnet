            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("LANGUAGES_DESCRIPTION", {
                        defaultValue: "Manage which languages are used to personalize your StreamNet experience."
                    })}
                </Typography>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("DISPLAY_LANGUAGE_SELECT_DESCRIPTION", {
                        defaultValue: "Select your preferred language for headlines, buttons, and other text from StreamNet."
                    })}
                </Typography>
            </div>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("SELECT_ADDITIONAL_LANGUAGES_DESCRIPTION", {
                        defaultValue: "Select additional languages for the content you want to see on StreamNet."
                    })}
                </Typography>
            </div>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("LANGUAGES_YOU_MAY_KNOW_DESCRIPTION", {
                        defaultValue: `Manage the languages StreamNet inferred based on your activity, 
