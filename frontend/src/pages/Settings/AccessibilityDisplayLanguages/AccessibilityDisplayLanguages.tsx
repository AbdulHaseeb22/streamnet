            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("ACCESSIBILITY_DISPLAY_LANGUAGES_DESCRIPTION", {
                        defaultValue: "Manage how StreamNet content is displayed to you."
                    })}
                </Typography>
            </div>
                            ...
                            <div>
                                ...
                                <Typography variant="subtitle2" component="div">
                                    {t("ACCESSIBILITY_DESCRIPTION", {
                                        defaultValue: `Manage aspects of your StreamNet experience such as limiting color 
                                        contrast and motion.`
                                    })}
                                </Typography>
                            </div>
                            ...
                            <div>
                                ...
                                <Typography variant="subtitle2" component="div">
                                    {t("DATA_USAGE_DESCRIPTION", {
                                        defaultValue: `Limit how StreamNet uses some of your network data. 
                                        These settings affect all the Twitter accounts on this browser.`
                                    })}
                                </Typography>
                            </div>
