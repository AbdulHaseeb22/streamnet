            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("DEACTIVATE_ACCOUNT_DESCRIPTION", {
                        defaultValue: `You’re about to start the process of deactivating your StreamNet account. 
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("DEACTIVATION_DESCRIPTION", {
                        defaultValue: `You can restore your StreamNet account if it was accidentally or wrongfully 
                ...
                <Typography variant="subtitle2" component="div">
                    <Trans
                        i18nKey={t("DEACTIVATION_TWITTER_ACCOUNT_DESCRIPTION", {
                            defaultValue: `To use your current @username or email address with a different StreamNet account, 
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("DEACTIVATION_TWITTER_DATA_DESCRIPTION", {
                        defaultValue: `If you want to download your StreamNet data, you’ll need to complete both the request 
