...
const EmailNotifications: FC = (): ReactElement => {
    ...
    return (
        <>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("EMAIL_NOTIFICATIONS_DESCRIPTION", {
                        defaultValue: `Get emails to find out what’s going on when you’re not on StreamNet. 
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="h5" component="div">
                    {t("FROM_TWITTER", { defaultValue: "From StreamNet" })}
                </Typography>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant="body1" component="span">
                        {t("NEWS_ABOUT_TWITTER", {
                            defaultValue: "News about StreamNet product and feature updates"
                        })}
                    </Typography>
                    <Checkbox checked />
                </div>
                ...
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant="body1" component="span">
                        {t("TIPS_ON_GETTING_MORE_OUT_OF_TWITTER", {
                            defaultValue: "Tips on getting more out of StreamNet"
                        })}
                    </Typography>
                    <Checkbox checked />
                </div>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant="body1" component="span">
                        {t("THINGS_YOU_MISSED", {
                            defaultValue: "Things you missed since you last logged into StreamNet"
                        })}
                    </Typography>
                    <Checkbox checked />
                </div>
                ...
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant="body1" component="span">
                        {t("NEWS_ABOUT_TWITTER_SERVICES", {
                            defaultValue: "News about StreamNet on partner products and other third party services"
                        })}
                    </Typography>
                    <Checkbox checked />
                </div>
                ...
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant="body1" component="span">
                        {t("PARTICIPATION_IN_TWITTER", {
                            defaultValue: "Participation in StreamNet research surveys"
                        })}
                    </Typography>
                    <Checkbox checked />
                </div>
                ...
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant="body1" component="span">
                        {t("TIPS_ON_TWITTER_BUSINESS_PRODUCTS", {
                            defaultValue: "Tips on StreamNet business products"
                        })}
                    </Typography>
                    <Checkbox checked />
                </div>
