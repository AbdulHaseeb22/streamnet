        ...
        <div className={classes.content}>
            <Typography variant="subtitle2" component="div" className={globalClasses.itemInfoWrapper}>
                {t("PERSONALIZATION_AND_DATA_DESCRIPTION", {
                    defaultValue: "Control how StreamNet personalizes content and collects and shares certain data."
                })}
            </Typography>
            <Divider />
            ...
            <div className={globalClasses.itemInfoWrapper}>
                ...
                <Typography variant="subtitle2" component="div">
                    {t("PERSONALIZED_ADS_DESCRIPTION", {
                        defaultValue: `You will always see ads on Twitter based on your StreamNet activity. 
            ...
            <div className={globalClasses.itemInfoWrapper}>
                ...
                <Typography variant="subtitle2" component="div">
                    {t("PERSONALIZE_BASED_ON_YOUR_INFERRED_IDENTITY_DESCRIPTION", {
                        defaultValue: `StreamNet will always personalize your experience based on information you’ve 
            ...
            <div className={globalClasses.itemInfoWrapper}>
                ...
                <Typography variant="subtitle2" component="div">
                    {t("PERSONALIZE_BASED_ON_THE_PLACES_DESCRIPTION", {
                        defaultValue: `StreamNet always uses some information, like where you signed up and your current 
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant="body1" component="span">
                        {t("ALLOW_USE_ACROSS_THE_WEB", {
                            defaultValue: "Allow use of where you see StreamNet content across the web"
                        })}
                    </Typography>
                ...
                <Typography variant="subtitle2" component="div">
                    {t("ALLOW_USE_ACROSS_THE_WEB_DESCRIPTION", {
                        defaultValue: `This setting lets StreamNet keep track of your visits to other websites that 
            ...
            <div className={globalClasses.itemInfoWrapper}>
                ...
                <Typography variant="subtitle2" component="div">
                    {t("ALLOW_ADDITIONAL_INFORMATION_DESCRIPTION", {
                        defaultValue: `StreamNet always shares information with business partners as a way to run and 
            ...
            <div className={globalClasses.contentLink}>
                <Typography variant="body1" component="span">
                    {t("SEE_YOUR_TWITTER_DATA", { defaultValue: "See your StreamNet data" })}
                </Typography>
                {ArrowRightIcon}
            </div>
        </div>
