        ...
        <>
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("PRIVACY_AND_SAFETY_DESCRIPTION", {
                        defaultValue: "Manage what information you see and share on StreamNet."
                    })}
                </Typography>
            </div>
            <Divider />
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="h5" component="div">
                    {t("YOUR_TWITTER_ACTIVITY", { defaultValue: "Your StreamNet activity" })}
                </Typography>
            </div>
                ...
                <List component="nav" aria-label="main mailbox folders">
                            ...
                            <div>
                                ...
                                <Typography variant="subtitle2" component="div">
                                    {t("CONTENT_YOU_SEE_DESCRIPTION", {
                                        defaultValue: `Decide what you see on StreamNet based on your preferences like 
                    ...
                    <div className={globalClasses.itemInfoWrapper}>
                        <Typography variant="h5" component="div">
                            {t("DATA_SHARING_AND_OFF_TWITTER_ACTIVITY", {
                                defaultValue: "Data sharing and off-StreamNet activity"
                            })}
                        </Typography>
                    </div>
                            ...
                            <div>
                                ...
                                <Typography variant="subtitle2" component="div">
                                    {t("ADS_PREFERENCES_DESCRIPTION", {
                                        defaultValue: "Manage your ads experience on StreamNet."
                                    })}
                                </Typography>
                            </div>
                            <div className={globalClasses.arrowIcon}>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_OFF_TWITTER_ACTIVITY}>
                        <ListItem>
                            ...
                            <div>
                                <Typography variant="body1" component="div">
                                    {t("OFF_TWITTER_ACTIVITY", { defaultValue: "Off-StreamNet activity" })}
                                </Typography>
                                <Typography variant="subtitle2" component="div">
                                    {t("OFF_TWITTER_ACTIVITY_DESCRIPTION", {
                                        defaultValue: `Manage how Twitter uses your online activity outside of StreamNet, 
                            ...
                            <div>
                                ...
                                <Typography variant="subtitle2" component="div">
                                    {t("DATA_SHARING_WITH_BUSINESS_PARTNERS_DESCRIPTION", {
                                        defaultValue: `Allow sharing of additional information with StreamNet’s business 
                                        partners.`
                                    })}
                                </Typography>
                            </div>
                            ...
                            <div>
                                ...
                                <Typography variant="subtitle2" component="div">
                                    {t("LOCATION_INFORMATION_DESCRIPTION", {
                                        defaultValue: `Manage the location information StreamNet uses to personalize your 
                                        experience.`
                                    })}
                                </Typography>
                            </div>
                    ...
                    <div className={globalClasses.itemInfoWrapper}>
                        <Typography variant="h5" component="div">
                            {t("LEARN_MORE_ABOUT_PRIVACY", {
                                defaultValue: "Learn more about privacy on StreamNet"
                            })}
                        </Typography>
                    </div>
