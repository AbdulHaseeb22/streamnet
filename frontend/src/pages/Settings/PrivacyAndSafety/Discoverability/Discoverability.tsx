            ...
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant="body1" component="span">
                        {t("DISCOVERABILITY_EMAIL_DESCRIPTION", {
                            defaultValue: "Let people who have your email address find you on StreamNet"
                        })}
                    </Typography>
                    <Checkbox />
                </div>
                <Typography variant="subtitle2" component="div">
                    {t("DISCOVERABILITY_EMAIL_CONNECT_DESCRIPTION", {
                        defaultValue: "Let people who have your email address find and connect with you on StreamNet."
                    })}
                    {" "}
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant="body1" component="span">
                        {t("DISCOVERABILITY_PHONE_DESCRIPTION", {
                            defaultValue: "Let people who have your phone number find you on StreamNet"
                        })}
                    </Typography>
                    <Checkbox />
                </div>
                <Typography variant="subtitle2" component="div">
                    {t("DISCOVERABILITY_PHONE_CONNECT_DESCRIPTION", {
                        defaultValue: "Let people who have your phone number find and connect with you on StreamNet."
                    })}
                    {" "}
                    <MuiLink href={EMAIL_AND_PHONE_DISCOVERABILITY_SETTINGS} variant="subtitle2" target="_blank" rel="noopener">
                        {t("LEARN_MORE", { defaultValue: "Learn more" })}
