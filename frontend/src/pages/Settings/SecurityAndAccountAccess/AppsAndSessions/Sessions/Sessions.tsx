            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("SESSIONS_DESCRIPTION", {
                        defaultValue: `Sessions are the devices you are using or that have used your StreamNet account. 
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("CURRENT_ACTIVE_SESSION_DESCRIPTION", {
                        defaultValue: "You’re logged into this StreamNet account on this device and are currently using it."
                    })}
                </Typography>
            </div>
            <Link
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant="subtitle2" component="div">
                    {t("LOG_OUT_OF_OTHER_SESSIONS_DESCRIPTION2", {
                        defaultValue: `Logging out will end 1 of your other active StreamNet sessions. It won’t affect 
