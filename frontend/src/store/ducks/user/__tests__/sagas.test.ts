...
describe("userSaga:", () => {
    ...
    describe("startUseStreamNetRequest:", () => {
        const worker = startUseStreamNetRequest();

        testLoadingStatus(worker, setUserLoadingStatus, LoadingStatus.LOADING);
        testCall(worker, UserApi.startUseStreamNet);
    ...
    testWatchSaga(userSaga, [
        ...
        { actionType: UserActionsType.START_USE_STREAMNET, workSaga: startUseStreamNetRequest },
