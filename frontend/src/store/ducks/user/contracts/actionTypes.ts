...
export enum UserActionsType {
    ...
    START_USE_STREAMNET = "user/START_USE_STREAMNET",
...
export interface startUseStreamNetActionInterface extends Action<UserActionsType> {
    type: UserActionsType.START_USE_STREAMNET;
}
